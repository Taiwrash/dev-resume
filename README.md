...
1. The aim of the project is to help two categories of people (a)Developers (b)Recruiting Companies/Industries.
...
- To be the No.1 point for a recruiter to confirm open source contributor in Africa and the world at large
...
Step 3 : Navigate to the `public/images` folder and put your image in it (note the name of the image and its extension(.ext))
...
b. If your PR get merged you have a proof for recruiters as an Open Source contributor by referring them to the live app on Heroku at <https://dev-resume.herokuapp.com>
