...
Step 3 : Navigate to [public/images](./public/images) folder and put your image in it (note the name of the image and its extension(.ext))

Step 4 : Recap step 3 dev-resume/public/images/

Step 5 : Return to the root directory

Step 6 : Open [data.json](./data.json) file
